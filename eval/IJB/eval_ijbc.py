...
parser.add_argument('--image-path', default='./data/IJB_release/IJB_release/IJBB', type=str, help='')
parser.add_argument('--result-dir', default='.', type=str, help='')
parser.add_argument('--batch-size', default=512, type=int, help='')
parser.add_argument('--network', default='iresnet50', type=str, help='')
parser.add_argument('--job', default='emore_cosface_mixcon_s_0.5_IJBC_E17', type=str, help='job name')
...
class Embedding(object):
    def __init__(self, prefix, data_shape, batch_size=1):
        ...
        model = torch.nn.DataParallel(backbone, device_ids=[0])
        self.model = model
        self.model.eval()
        src = np.array([
            [30.2946, 51.6963],
...
def get_image_feature(img_path, files_list, model_path, epoch, gpu_id):
    ...
    # replaced 256 -> cfg.embedding_size*2
